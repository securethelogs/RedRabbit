...
________     ________________       ______ ______ __________  
___  __ \__________  /__  __ \_____ ___  /____  /____(_)_  /_                \\\,_     
__  /_/ /  _ \  __  /__  /_/ /  __ `/_  __ \_  __ \_  /_  __/                 \` ,\    
_  _, _//  __/ /_/ / _  _, _// /_/ /_  /_/ /  /_/ /  / / /_              __,.-" =__)    
/_/ |_| \___/\__,_/  /_/ |_| \__,_/ /_.___//_.___//_/  \__/           ."        )      
                                                                   ,_/   ,    \/\_     
                                                                   \_|    )_-\ \_-`    
Creator: https://securethelogs.com / @securethelogs
...
$picklogo = Get-Random -Minimum 1 -Maximum 4

if ($picklogo -eq 1){$logo}
if ($picklogo -eq 2){$logo2}
if ($picklogo -eq 3){$logo3}
...
while($true){
    ...
    Write-Output "Option 8: Test Extraction Connection              * Option 17: Query DLLs"
